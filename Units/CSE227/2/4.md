# Canva (Digital Signature) with colour options
...
<LinearLayout xmlns:android="http://schemas.android.com/apk/res/android"
    ...
    <com.skp3214.canvas.SignatureView
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showColorChooserDialog() {
        ...
        val colorValues = arrayOf(0xFF000000.toInt(), 0xFFFF0000.toInt(), 0xFF00FF00.toInt(), 0xFF0000FF.toInt())

        AlertDialog.Builder(this)
            .setTitle("Choose Color")
            .setItems(colors) { _, which ->
                signatureView.setPaintColor(colorValues[which])
            }
            .show()
    }
}
